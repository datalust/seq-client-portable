...
{
    /// <summary>
    /// Manages reconnection period and transient fault response for <see cref="PortablePeriodicBatchingSink"/>.
    ...
    /// </summary>
    /// <remarks>
    /// Currently used only by <see cref="PortablePeriodicBatchingSink"/>, but may
    ...
    /// </remarks>
    class PortableBatchedConnectionStatus
    {
        ...
        public PortableBatchedConnectionStatus(TimeSpan period)
        {
